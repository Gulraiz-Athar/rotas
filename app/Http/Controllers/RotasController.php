...
class RotasController extends Controller
{
    ...
    public function rotas_date($id = 0)
    {
        $userId = Auth::id();
        $user = Auth::user();
        $created_by = $user->get_created_by();
    ...
    public function two_weeks($id = 0)
    {
        $userId = Auth::id();
        $user = Auth::user();
        $created_by = $user->get_created_by();
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $week_date = Rotas::gettwoWeekArray($date_formate,$week,$start_day);
        $emp_setting = Auth::user()->employee_setting;
        $day_off = 'hide';
        $leave_display = 'hide';
        $availability_display = 'hide';
        ...
        // $week_date['6'] = '2021-02-07';
        $week_date['week_start'] = date('Y-m-d', strtotime($week_date[0]));
        $week_date['week_end'] = date('Y-m-d', strtotime($week_date[13]));
        // return $week_date;
        return view('rotas.two_weeks', compact('location_option', 'role_option', 'roles', 'employees', 'week_date', 'created_by', 'first_location','temp_week', 'day_off', 'leave_display', 'availability_display'));
    }


    public function three_weeks($id = 0)
    {
        $userId = Auth::id();
        $user = Auth::user();
        $created_by = $user->get_created_by();
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $week_date = Rotas::getthreeWeekArray($date_formate,$week,$start_day);
        $emp_setting = Auth::user()->employee_setting;
        $day_off = 'hide';
        $leave_display = 'hide';
        $availability_display = 'hide';
        ...
        // $week_date['6'] = '2021-02-07';
        $week_date['week_start'] = date('Y-m-d', strtotime($week_date[0]));
        $week_date['week_end'] = date('Y-m-d', strtotime($week_date[20]));
        // return $week_date;
        return view('rotas.three_weeks', compact('location_option', 'role_option', 'roles', 'employees', 'week_date', 'created_by', 'first_location','temp_week', 'day_off', 'leave_display', 'availability_display'));
    }

    public function four_weeks($id = 0)
    {
        $userId = Auth::id();
        $user = Auth::user();
        $created_by = $user->get_created_by();
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $week_date = Rotas::getfourWeekArray($date_formate,$week,$start_day);
        $emp_setting = Auth::user()->employee_setting;
        $day_off = 'hide';
        $leave_display = 'hide';
        $availability_display = 'hide';
        ...
        // $week_date['6'] = '2021-02-07';
        $week_date['week_start'] = date('Y-m-d', strtotime($week_date[0]));
        $week_date['week_end'] = date('Y-m-d', strtotime($week_date[27]));
        // return $week_date;
        return view('rotas.four_weeks', compact('location_option', 'role_option', 'roles', 'employees', 'week_date', 'created_by', 'first_location','temp_week', 'day_off', 'leave_display', 'availability_display'));
    }
   ...
   /**
    ...
    public function createtwo(Request $request)
    {
        ...
        return view('rotas.createtwo',compact('role_option','user_id','date','first_location'));
    }
    ...
    public function createthree(Request $request)
    {
        ...
        return view('rotas.createthree',compact('role_option','user_id','date','first_location'));
    }
    ...
    public function createfour(Request $request)
    {
        ...
        return view('rotas.createfour',compact('role_option','user_id','date','first_location'));
    }
    ...
    public function clear_weektwosolo()
    {
        //$array =  array('status'=>'error','msg'=> __('This operation is not perform due to demo mode.'));
    ...
    public function clear_weektwoduo()
    {
        //$array =  array('status'=>'error','msg'=> __('This operation is not perform due to demo mode.'));
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $week_date = Rotas::getsecondweekArray('Y-m-d',$week,$start_day);
    ...
    public function clear_weekthirdsolo()
    {
        //$array =  array('status'=>'error','msg'=> __('This operation is not perform due to demo mode.'));
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $week_date = Rotas::getthirdweekArray('Y-m-d',$week,$start_day);
    ...
    public function clear_weekthirdduo()
    {
        //$array =  array('status'=>'error','msg'=> __('This operation is not perform due to demo mode.'));
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $week_date = Rotas::getthirdweekArraytwo('Y-m-d',$week,$start_day);
    ...
    public function clear_weekthirdtrio()
    {
        //$array =  array('status'=>'error','msg'=> __('This operation is not perform due to demo mode.'));
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $week_date = Rotas::getthirdweekArraytrio('Y-m-d',$week,$start_day);
    ...
    public function clear_weekfoursolo()
    {
        //$array =  array('status'=>'error','msg'=> __('This operation is not perform due to demo mode.'));
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $week_date = Rotas::getfourweekArraysolo('Y-m-d',$week,$start_day);
    ...
    public function clear_weekfourduo()
    {
        //$array =  array('status'=>'error','msg'=> __('This operation is not perform due to demo mode.'));
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $week_date = Rotas::getfourweekArrayduo('Y-m-d',$week,$start_day);
    ...
    public function clear_weekfourtrio()
    {
        //$array =  array('status'=>'error','msg'=> __('This operation is not perform due to demo mode.'));
    ...
    public function clear_weekfourquad()
    {
        //$array =  array('status'=>'error','msg'=> __('This operation is not perform due to demo mode.'));
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $week_date = Rotas::getfourweekArrayquadra('Y-m-d',$week,$start_day);
    ...
    public function week_sheet()
    {
        ...
        $thead = '<thead> <tr class="text-center">
            <th></th>
            <th><span>MON</span><br><span>' . __($week_date1[0]) . '</span></th>
            <th><span>TUE</span><br><span>' . __($week_date1[1]) . '</span></th>
            <th><span>WED</span><br><span>' . __($week_date1[2]) . '</span></th>
            <th><span>THU</span><br><span>' . __($week_date1[3]) . '</span></th>
            <th><span>FRI</span><br><span>' . __($week_date1[4]) . '</span></th>
            <th><span>SAT</span><br><span>' . __($week_date1[5]) . '</span></th>
            <th><span>SUN</span><br><span>' . __($week_date1[6]) . '</span></th>
            </tr></thead>';
        $thead2 = '
            <th></th>
    ...
    public function week_sheetam()
    {
        ...
        if (count($employees) != 0) {
            foreach ($employees as $employee)
            {
                $tbody .= $employee->getWorkScheduleam($employee->id, $week1, $location_id);
            }
        } else {
            $tbody = '<tr>
                        <td colspan="8">
    ...
    public function week_sheetpm()
    {
        ...
        if (count($employees) != 0) {
            foreach ($employees as $employee)
            {
                $tbody .= $employee->getWorkSchedulepm($employee->id, $week1, $location_id);
            }
        } else {
            $tbody = '<tr>
                        <td colspan="8">
    ...
    public function week_sheet_second()
    {
        $userId = Auth::id();
        $created_by = $_REQUEST['created_by'];
        $week1 = 0;
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $date_formate = User::CompanyDateFormat('d M Y');
        $week_date1 = Rotas::secondweeksolo($date_formate, $week, $start_day);
        $week_date = Rotas::secondweeksolo('Y-m-d', $week, $start_day);
        $week_date123 = Rotas::secondweeksolo('d M Y', $week, $start_day);
        $where = '0 = 0 ';
        $emp_only_see_own_rota = 0;
        if (Auth::user()->acount_type == 3) {
            $employee_data = Employee::whereRaw('id = ' . $created_by . ' ')->first();
        ...
        if (count($employees) != 0) {
            foreach ($employees as $employee)
            {
                $tbody .= $employee->getsecondWorkSchedule($employee->id, $week1, $location_id);
            }
        } else {
            $tbody = '<tr>
                        <td colspan="8">
        ...
        // getsecondWorkSchedule($id = 0, $week = 0, $location_id = 0);
        // return $tbody;
        ...
        if(Auth::user()->type == 'company')
        {
            $week_exp = Employee::getCompanyWeeklyUserSalaryone($week1, $created_by, $location_id, $role_id);
        }

        $array = array('table' => $thead . '<tbody>' . $tbody . '</tbody><tfoot class="bt2"></tfoot>', 'title' => $week_date1[0] . ' - ' . $week_date1[13], 'week_exp' => $week_exp, 'thead' => $thead2);
        return $array;
    }

    public function week_sheet_second_two()
    {
        $userId = Auth::id();
        $created_by = $_REQUEST['created_by'];
        $week1 = 0;
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $date_formate = User::CompanyDateFormat('d M Y');
        $week_date1 = Rotas::getsecondweekArray($date_formate, $week, $start_day);
        $week_date = Rotas::getsecondweekArray('Y-m-d', $week, $start_day);
        $week_date123 = Rotas::getsecondweekArray('d M Y', $week, $start_day);
        $where = '0 = 0 ';
        $emp_only_see_own_rota = 0;
        if (Auth::user()->acount_type == 3) {
            $employee_data = Employee::whereRaw('id = ' . $created_by . ' ')->first();
        ...
        if (count($employees) != 0) {
            foreach ($employees as $employee)
            {
                $tbody .= $employee->getsecondWorkScheduletwo($employee->id, $week1, $location_id);
            }
        } else {
            $tbody = '<tr>
                        <td colspan="8">
        ...
        if(Auth::user()->type == 'company')
        {
            $week_exp = Employee::getCompanyWeeklyUserSalarytwo($week1, $created_by, $location_id, $role_id);
        }
    ...
    public function week_sheet_third()
    {
        $userId = Auth::id();
        $created_by = $_REQUEST['created_by'];
        $week1 = 0;
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $date_formate = User::CompanyDateFormat('d M Y');
        $week_date1 = Rotas::thirdweeksolo($date_formate, $week, $start_day);
        $week_date = Rotas::thirdweeksolo('Y-m-d', $week, $start_day);
        $week_date123 = Rotas::thirdweeksolo('d M Y', $week, $start_day);
        $where = '0 = 0 ';
        $emp_only_see_own_rota = 0;
        if (Auth::user()->acount_type == 3) {
            $employee_data = Employee::whereRaw('id = ' . $created_by . ' ')->first();
        ...
        if (count($employees) != 0) {
            foreach ($employees as $employee)
            {
                $tbody .= $employee->getthirdWorkSchedulethird($employee->id, $week1, $location_id);
            }
        } else {
            $tbody = '<tr>
                        <td colspan="8">
        ...
        if(Auth::user()->type == 'company')
        {
            $week_exp = Employee::getCompanyWeeklyUserSalarythree($week1, $created_by, $location_id, $role_id);
        }

        $array = array('table' => $thead . '<tbody>' . $tbody . '</tbody><tfoot class="bt2"></tfoot>', 'title' => $week_date1[0] . ' - ' . $week_date1[20], 'week_exp' => $week_exp, 'thead' => $thead2);
        return $array;
    }

    public function week_sheet_third_two()
    {
        $userId = Auth::id();
        $created_by = $_REQUEST['created_by'];
        $week1 = 0;
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $date_formate = User::CompanyDateFormat('d M Y');
        $week_date1 = Rotas::getthirdweekArraytwo($date_formate, $week, $start_day);
        $week_date = Rotas::getthirdweekArraytwo('Y-m-d', $week, $start_day);
        $week_date123 = Rotas::getthirdweekArraytwo('d M Y', $week, $start_day);
        $where = '0 = 0 ';
        $emp_only_see_own_rota = 0;
        if (Auth::user()->acount_type == 3) {
            $employee_data = Employee::whereRaw('id = ' . $created_by . ' ')->first();
        ...
        if (count($employees) != 0) {
            foreach ($employees as $employee)
            {
                $tbody .= $employee->getthirdWorkScheduleduo($employee->id, $week1, $location_id);
            }
        } else {
            $tbody = '<tr>
                        <td colspan="8">
        ...
        if(Auth::user()->type == 'company')
        {
            $week_exp = Employee::getCompanyWeeklyUserSalarythreeduo($week1, $created_by, $location_id, $role_id);
        }
    ...
    public function week_sheet_third_three()
    {
        $userId = Auth::id();
        $created_by = $_REQUEST['created_by'];
        $week1 = 0;
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $date_formate = User::CompanyDateFormat('d M Y');
        $week_date1 = Rotas::getthirdweekArraytrio($date_formate, $week, $start_day);
        // return $week_date1;
        $week_date = Rotas::getthirdweekArraytrio('Y-m-d', $week, $start_day);
        $week_date123 = Rotas::getthirdweekArraytrio('d M Y', $week, $start_day);
        $where = '0 = 0 ';
        $emp_only_see_own_rota = 0;
        if (Auth::user()->acount_type == 3) {
            $employee_data = Employee::whereRaw('id = ' . $created_by . ' ')->first();
        ...
        if (count($employees) != 0) {
            foreach ($employees as $employee)
            {
                $tbody .= $employee->getthirdWorkScheduletrio($employee->id, $week1, $location_id);
            }
        } else {
            $tbody = '<tr>
                        <td colspan="8">
        ...
        if(Auth::user()->type == 'company')
        {
            $week_exp = Employee::getCompanyWeeklyUserSalarythreetrio($week1, $created_by, $location_id, $role_id);
        }
    ...
    public function week_sheet_four()
    {
        $userId = Auth::id();
        $created_by = $_REQUEST['created_by'];
        $week1 = 0;
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $date_formate = User::CompanyDateFormat('d M Y');
        $week_date1 = Rotas::getfourWeekArray($date_formate, $week, $start_day);

        $week_date = Rotas::getfourWeekArray('Y-m-d', $week, $start_day);
        $week_date123 = Rotas::getfourWeekArray('d M Y', $week, $start_day);
        $where = '0 = 0 ';
        $emp_only_see_own_rota = 0;
        if (Auth::user()->acount_type == 3) {
            $employee_data = Employee::whereRaw('id = ' . $created_by . ' ')->first();
        ...
        if (count($employees) != 0) {
            foreach ($employees as $employee)
            {
                $tbody .= $employee->getfourWorkSchedulesolo($employee->id, $week1, $location_id);
            }
        } else {
            $tbody = '<tr>
                        <td colspan="8">
        ...
        if(Auth::user()->type == 'company')
        {
            $week_exp = Employee::getCompanyWeeklyUserSalaryfour($week1, $created_by, $location_id, $role_id);
        }

        $array = array('table' => $thead . '<tbody>' . $tbody . '</tbody><tfoot class="bt2"></tfoot>', 'title' => $week_date1[0] . ' - ' . $week_date1[27], 'week_exp' => $week_exp, 'thead' => $thead2);
        return $array;
    }

    public function week_sheet_four_two()
    {
        $userId = Auth::id();
        $created_by = $_REQUEST['created_by'];
        $week1 = 0;
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $date_formate = User::CompanyDateFormat('d M Y');
        $week_date1 = Rotas::getfourweekArrayduo($date_formate, $week, $start_day);
        // print_r($week_date1);
        $week_date = Rotas::getfourweekArrayduo('Y-m-d', $week, $start_day);
        $week_date123 = Rotas::getfourweekArrayduo('d M Y', $week, $start_day);
        $where = '0 = 0 ';
        $emp_only_see_own_rota = 0;
        if (Auth::user()->acount_type == 3) {
            $employee_data = Employee::whereRaw('id = ' . $created_by . ' ')->first();
        ...
        if (count($employees) != 0) {
            foreach ($employees as $employee)
            {
                $tbody .= $employee->getfourWorkScheduleduo($employee->id, $week1, $location_id);
            }
        } else {
            $tbody = '<tr>
                        <td colspan="8">
        ...
        if(Auth::user()->type == 'company')
        {
            $week_exp = Employee::getCompanyWeeklyUserSalaryfourduo($week1, $created_by, $location_id, $role_id);
        }
    ...
    public function week_sheet_four_three()
    {
        $userId = Auth::id();
        $created_by = $_REQUEST['created_by'];
        $week1 = 0;
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $date_formate = User::CompanyDateFormat('d M Y');
        $week_date1 = Rotas::getfourweekArraytrio($date_formate, $week, $start_day);
        $week_date = Rotas::getfourweekArraytrio('Y-m-d', $week, $start_day);
        $week_date123 = Rotas::getfourweekArraytrio('d M Y', $week, $start_day);
        $where = '0 = 0 ';
        $emp_only_see_own_rota = 0;
        if (Auth::user()->acount_type == 3) {
            $employee_data = Employee::whereRaw('id = ' . $created_by . ' ')->first();
        ...
        if (count($employees) != 0) {
            foreach ($employees as $employee)
            {
                $tbody .= $employee->getfourWorkScheduletrio($employee->id, $week1, $location_id);
            }
        } else {
            $tbody = '<tr>
                        <td colspan="8">
        ...
        if(Auth::user()->type == 'company')
        {
            $week_exp = Employee::getCompanyWeeklyUserSalaryfourtrio($week1, $created_by, $location_id, $role_id);
        }
    ...
    public function week_sheet_four_quad()
    {
        $userId = Auth::id();
        $created_by = $_REQUEST['created_by'];
        $week1 = 0;
        ...
        $start_day = (!empty($setting['company_week_start'])) ? $setting['company_week_start'] : 'monday';
        $date_formate = User::CompanyDateFormat('d M Y');
        $week_date1 = Rotas::getfourweekArrayquadra($date_formate, $week, $start_day);
        $week_date = Rotas::getfourweekArrayquadra('Y-m-d', $week, $start_day);
        $week_date123 = Rotas::getfourweekArrayquadra('d M Y', $week, $start_day);
        $where = '0 = 0 ';
        $emp_only_see_own_rota = 0;
        if (Auth::user()->acount_type == 3) {
            $employee_data = Employee::whereRaw('id = ' . $created_by . ' ')->first();
        ...
        if (count($employees) != 0) {
            foreach ($employees as $employee)
            {
                $tbody .= $employee->getfourWorkSchedulequadra($employee->id, $week1, $location_id);
            }
        } else {
            $tbody = '<tr>
                        <td colspan="8">
        ...
        if(Auth::user()->type == 'company')
        {
            $week_exp = Employee::getCompanyWeeklyUserSalaryfourquad($week1, $created_by, $location_id, $role_id);
        }
    ...
    public function shift_copy()
    {
        ...
        $user_have_role = Profile::WhereRaw('user_id = '. $_REQUEST['drop_user_id'].' ')
                                    ...
                                    ->count();
        $manager_add_edit_delete_rotas = '';
        if(!is_null(Auth::user()->manager_permission))
        {
            $permission = Auth::user()->manager_permission;
            $per = json_decode($permission, true);
            $manager_add_edit_delete_rotas = $per['manager_add_edit_delete_rotas'];
        }
        
        if(Auth::user()->type == 'company' || Auth::user()->acount_type == 1 || $manager_add_edit_delete_rotas == 1)        {
    ...
    public function un_publish_weektwosolo()
    {
        $array =  array('status'=>'error', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
        ...
        $week = (!empty($_REQUEST['week'])) ? $_REQUEST['week'] * 14 : 0*14;
        $created_by = $_REQUEST['created_by'];
        $location_id = $_REQUEST['location_id'];
    ...
    public function un_publish_weektwoduo()
    {
        $array =  array('status'=>'error', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function un_publish_weekthreesolo()
    {
        $array =  array('status'=>'error', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
        ...
        $week = (!empty($_REQUEST['week'])) ? $_REQUEST['week'] * 21 : 0*21;
        $created_by = $_REQUEST['created_by'];
        $location_id = $_REQUEST['location_id'];
    ...
    public function un_publish_weekthreeduo()
    {
        $array =  array('status'=>'error', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function un_publish_weekthreetrio()
    {
        $array =  array('status'=>'error', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function un_publish_weekfoursolo()
    {
        $array =  array('status'=>'error', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
        ...
        $week = (!empty($_REQUEST['week'])) ? $_REQUEST['week'] * 28 : 0*28;
        $created_by = $_REQUEST['created_by'];
        $location_id = $_REQUEST['location_id'];
    ...
    public function un_publish_weekfourduo()
    {
        $array =  array('status'=>'error', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function un_publish_weekfourtrio()
    {
        $array =  array('status'=>'error', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function un_publish_weekfourquad()
    {
        $array =  array('status'=>'error', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function publish_weektwosolo()
    {
        $array =  array('status'=>'success', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function publish_weektwoduo()
    {
        $array =  array('status'=>'success', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function publish_weekthreesolo()
    {
        $array =  array('status'=>'success', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function publish_weekthreeduo()
    {
        $array =  array('status'=>'success', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function publish_weekthreetrio()
    {
        $array =  array('status'=>'success', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function publish_weekfoursolo()
    {
        $array =  array('status'=>'success', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function publish_weekfourduo()
    {
        $array =  array('status'=>'success', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function publish_weekfourtrio()
    {
        $array =  array('status'=>'success', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function publish_weekfourquad()
    {
        $array =  array('status'=>'success', 'msg'=> __('Please Try Again'));
        $userId = Auth::id();
        $user = Auth::user();
    ...
    public function add_amoff()
    {
        ...
        {
            $profile = Profile::whereRaw('user_id = '.$_REQUEST['user_id'].'')->first();
            if(!empty($profile->custom_am_off))
            {
                $date_array = json_decode($profile->custom_am_off, true);
                $date_inarray = in_array($_REQUEST['date'], $date_array);
                if($date_inarray) {
                    $remove_date = array_diff( $date_array, $date);
                    $date_array = (!empty($remove_date)) ? array_values($remove_date) : '' ;
                    $date_status = '';
                    $msg = __('Remove AM off successfully');
                } else {
                    array_push( $date_array, $_REQUEST['date'] );
                    $date_status = 'add';
                    $date_status = '<div class="text-center text-danger day_off_leave cus_day_off_leave ui-sortable-handle"  data-date="'.$_REQUEST['date'].'" data-placement="top" data-html="true" data-toggle="tooltip" title="'.__('This is').$profile->getUserName->first_name.__(' AM Off').'">'.__(' AM Off').'</div>';
                    $msg = __('Add AM off successfully');
                    $settings  = Utility::settings(Auth::user()->ownerId());
                    if(isset($settings['days_off_notificaation']) && $settings['days_off_notificaation'] ==1){

                        $mesg = __('AM off to date the ').$_REQUEST['date'].'.';
                        Utility::send_slack_msg($mesg);

                    }
                    if(isset($settings['telegram_days_off_notificaation']) && $settings['telegram_days_off_notificaation'] ==1){
                        $resp = __('AM off to date the ').$_REQUEST['date'].'.';
                        Utility::send_telegram_msg($resp);
                    }
                }
            } else {
            ...
            // print_r($date_array);
            $profile->custom_am_off = (!empty($date_array)) ? json_encode($date_array) : null ;
            $profile->save();
            $array =  array('status'=>'success', 'msg'=> $msg,'date_status' => $date_status, 'date' => $_REQUEST['date']);
        }
        return response()->json($array);
    ...
    public function add_pmoff()
    {
        ...
        {
            $profile = Profile::whereRaw('user_id = '.$_REQUEST['user_id'].'')->first();
            if(!empty($profile->custom_pm_off))
            {
                $date_array = json_decode($profile->custom_pm_off, true);
                $date_inarray = in_array($_REQUEST['date'], $date_array);
                if($date_inarray) {
                    $remove_date = array_diff( $date_array, $date);
                    $date_array = (!empty($remove_date)) ? array_values($remove_date) : '' ;
                    $date_status = '';
                    $msg = __('Remove PM off successfully');
                } else {
                    array_push( $date_array, $_REQUEST['date'] );
                    $date_status = 'add';
                    $date_status = '<div class="text-center text-danger day_off_leave cus_day_off_leave ui-sortable-handle"  data-date="'.$_REQUEST['date'].'" data-placement="top" data-html="true" data-toggle="tooltip" title="'.__('This is').$profile->getUserName->first_name.__(' PM Off').'">'.__(' AM Off').'</div>';
                    $msg = __('Add PM off successfully');
                    $settings  = Utility::settings(Auth::user()->ownerId());
                    if(isset($settings['days_off_notificaation']) && $settings['days_off_notificaation'] ==1){
                ...
                $date_array[] = $_REQUEST['date'];
                $date_status = 'add';
                $date_status = '<div class="text-center text-danger day_off_leave cus_day_off_leave ui-sortable-handle" data-date="'.$_REQUEST['date'].'" data-placement="top" data-html="true" data-toggle="tooltip" title="'.__('This is').$profile->getUserName->first_name.__(' PM Off').'">'.__(' PM Off').'</div>';
                $msg = __('Add PM off successfully');
                 $settings  = Utility::settings(Auth::user()->ownerId());
                    if(isset($settings['days_off_notificaation']) && $settings['days_off_notificaation'] ==1){
            ...
            // print_r($date_array);
            $profile->custom_pm_off = (!empty($date_array)) ? json_encode($date_array) : null ;
            $profile->save();
            $array =  array('status'=>'success', 'msg'=> $msg,'date_status' => $date_status, 'date' => $_REQUEST['date']);
        }
        return response()->json($array);
    ...
    public function copy_week_sheet2solo(Request $request)
    {
        $rotas_id_array = $request->rotas_id_array;
        $error_msg = [];
        ...
        if (Auth::user()->type == 'company' || $manager_add_edit_delete_rotas == 1 || Auth::user()->type == 'employee') {
            if(!empty($rotas_id_array)) {
                foreach ($rotas_id_array as $key => $rotas_id) {
                    ...
                    $note = $drag_rotas_data['note'];
                    $created_by = $drag_rotas_data['create_by'];
                    $drop_rotas_date = date('Y-m-d', strtotime($rotas_date . ' + 14 days'));
                    $user_have_role = Profile::WhereRaw('user_id = ' . $drop_user_id . ' ')
                        ->WhereRaw(' FIND_IN_SET(' . $rotas_role_id . ', role_id) ')
                        ->count();
                    $time_override = Rotas::WhereRaw('user_id = ' . $drop_user_id . ' ')
    ...
    public function copy_week_sheet3solo(Request $request)
    {
        $rotas_id_array = $request->rotas_id_array;
        $error_msg = [];
        ...
        if (Auth::user()->type == 'company' || $manager_add_edit_delete_rotas == 1 || Auth::user()->type == 'employee') {
            if(!empty($rotas_id_array)) {
                foreach ($rotas_id_array as $key => $rotas_id) {
                    ...
                    $note = $drag_rotas_data['note'];
                    $created_by = $drag_rotas_data['create_by'];
                    $drop_rotas_date = date('Y-m-d', strtotime($rotas_date . ' + 21 days'));
                    $user_have_role = Profile::WhereRaw('user_id = ' . $drop_user_id . ' ')
                        ->WhereRaw(' FIND_IN_SET(' . $rotas_role_id . ', role_id) ')
                        ->count();
                    $time_override = Rotas::WhereRaw('user_id = ' . $drop_user_id . ' ')
    ...
    public function copy_week_sheet4solo(Request $request)
    {
        $rotas_id_array = $request->rotas_id_array;
        $error_msg = [];
        ...
        if (Auth::user()->type == 'company' || $manager_add_edit_delete_rotas == 1 || Auth::user()->type == 'employee') {
            if(!empty($rotas_id_array)) {
                foreach ($rotas_id_array as $key => $rotas_id) {
                    ...
                    $note = $drag_rotas_data['note'];
                    $created_by = $drag_rotas_data['create_by'];
                    $drop_rotas_date = date('Y-m-d', strtotime($rotas_date . ' + 28 days'));
                    $user_have_role = Profile::WhereRaw('user_id = ' . $drop_user_id . ' ')
                        ->WhereRaw(' FIND_IN_SET(' . $rotas_role_id . ', role_id) ')
                        ->count();
                    $time_override = Rotas::WhereRaw('user_id = ' . $drop_user_id . ' ')
