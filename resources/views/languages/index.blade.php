                                                ...
                                                <div class="nav-wrapper mb-4">
                                                    <ul class="nav nav-pills nav-pills-lang nav-fill flex-column flex-md-row" id="pills-tab" role="tablist">
                                                        <li class="nav-item mx-2" role="presentation">
                                                            <button class="nav-link active nav-link-tabs" id="pills-user-tab-1" data-bs-toggle="pill"
                                                                data-bs-target="#home" type="button">{{ __('Labels')}}</button>
                                                        </li>
                                                        <li class="nav-item mx-2" role="presentation">
                                                            <button class="nav-link mb-sm-3 mb-md-0 nav-link-tabs" id="pills-user-tab-2" data-bs-toggle="pill"
...
@push('pagescript')
    <script>
        $('.nav-link-tabs').click(function() {
            if(this.id == 'pills-user-tab-1'){
                $('#home').removeClass('d-none');
                $('#profile').addClass('d-none');
            }
            if(this.id == 'pills-user-tab-2'){
