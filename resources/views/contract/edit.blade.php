...
<div class="row">
    <div class="form-group col-md-6">
        {{ Form::label('employee', __('Employee Name'),['class' => 'col-form-label']) }}
       ...
       <div class="form-group col-md-6">
          ...
          {{ Form::text('contract_name',null, array('class' => 'form-control')) }}
      </div>
      <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
        {{ Form::label('value', __('Salary'),['class' => 'col-form-label']) }}
        {{ Form::number('value',null, array('class' => 'form-control', 'step' => '0.01', 'min' => '0')) }}
    </div>
    <div class="form-group col-md-6">
