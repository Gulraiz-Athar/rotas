...
<body class="{{ $color }}">
    ...
    <nav class="navbar navbar-expand-md navbar-dark default top-nav-collapse">
        <div class="container">
            <a class="navbar-brand bg-transparent" href="#">
                ...
                <img alt="logo" src="{{$logo.('logo-light.png')}}" class="navbar-brand-img auth-navbar-brand" style="width: 150px;">
            </a>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="https://demo.rajodiya.com/rotago-saas/" class="btn btn-light me-2">
                            <i class="far fa-eye me-2"></i>Live Demo</a>
                        <a href="https://codecanyon.net/item/rotago-saas-staff-scheduling-tool/30350910" class="btn btn-outline-light">
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            src="{{ asset('landing/images/rotago-pic-2.png') }}"
            alt=""
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('landing/images/rotago-pic-1.png') }}" alt="Datta Able Admin Template"
                ...
                <div class="col-xl-9 col-lg-6 col-md-12 col-sm-12">
                    <div class="row feature-img-row m-auto">
                         <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/images/rotago-pic-1.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight p-3" data-wow-delay="0.2s"
                                alt="Admin" />
                        </div>
                         <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/images/rotago-pic-2.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight p-3" data-wow-delay="0.4s"
                                alt="Admin" />
                        </div>
                         <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/images/rotago-pic-3.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight p-3" data-wow-delay="0.6s"
                                alt="Admin" />
                        </div>
                         <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/images/rotago-pic-4.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight p-3" data-wow-delay="0.8s"
                                alt="Admin" />
                        </div>
                         <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/images/rotago-pic-5.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight p-3" data-wow-delay="0.3s"
                                alt="Admin" />
                        </div>
                         <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/images/rotago-pic-6.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight p-3" data-wow-delay="0.5s"
                                alt="Admin" />
                        </div>
                         <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/images/rotago-pic-7.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight p-3" data-wow-delay="0.7s"
                                alt="Admin" />
                        </div>
                         <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/images/rotago-pic-8.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight p-3" data-wow-delay="0.9s"
                                alt="Admin" />
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    @if($darklayout == 'on')
                    <img src="{{ asset(Storage::url('logo/logo-light.png')) }}" alt="" class="img-fluid" />
                @else
