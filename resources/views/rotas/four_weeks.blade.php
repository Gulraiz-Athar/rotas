                    ...
                    <div class="card">
                        <div class="card-header card-body">
                            <div class="row justify-content-between align-items-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-auto my-auto">
                                            <div class="d-inline-block text-white">
                                                ...
                                                &nbsp;<span class="weak_go_html weak_go_html text-primary"><b>{{ $week_date[0] . ' - ' . $week_date[27] }}</b></span>&nbsp;
                                    ...
                                    <div
                                            ...
                                            <div class="btn-group card-option rotas_filter">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                    <a href="#"
                                                        ...
                                                        <a href="#" class="dropdown-item hide_rss"
                                                            id="add_remove_amoff">
                                                            {{ __(' Add / Remove AM Off') }}
                                                        </a>
                                                        <a href="#" class="dropdown-item hide_rss"
                                                            id="add_remove_pmoff">
                                                            {{ __(' Add / Remove PM Off') }}
                                                        </a>
                                                        <a href="#" class="dropdown-item hide_rss"
                                        ...
                                        <div class="rotas_filter_main_div_responce">
                                            <div class="add_remove_amoff" style="display: none;">
                                                <span>{{ __('Click a day to set employees AM off') }}</span> &nbsp;
                                                <button type="button"
                                                    class="dropdown-toggle btn btn-sm btn-primary btn-icon m-1 dayoff_close"
                                                    data-toggel="tooltip"
                                                    title="{{ __('Back to Rota Builder') }}"><span
                                        ...
                                        <div class="rotas_filter_main_div_responce">
                                            <div class="add_remove_pmoff" style="display: none;">
                                                <span>{{ __('Click a day to set employees PM off') }}</span> &nbsp;
                                                <button type="button"
                                                    class="dropdown-toggle btn btn-sm btn-primary btn-icon m-1 dayoff_close"
                                                    data-toggel="tooltip"
                                                    title="{{ __('Back to Rota Builder') }}"><span
                                ...
                                @elseif(Auth::user()->acount_type == 2 && !is_null(Auth::user()->manager_permission) && $manager_add_edit_delete_rotas == 1)
                                    <div
                                        class="col-md-4 d-flex align-items-center justify-content-between justify-content-md-end">
                                        <div class="rotas_filter_main_div">
                                            <div class="btn-group card-option">
                                ...
                                <table class="table work_sheet_table1">
                                    <thead>
                                        <tr class="text-center work_sheet_table">
                                            <th>Week 1</th>
                                            <th><span>MON</span><br><span>{{ $week_date[0] }}</span>
                                            </th>
                                            <th><span>TUE</span><br><span>{{ $week_date[1] }}</span>
                                            </th>
                                            <th><span>WED</span><br><span>{{ $week_date[2] }}</span>
                                            </th>
                                            <th><span>THU</span><br><span>{{ $week_date[3] }}</span>
                                            </th>
                                            <th><span>FRI</span><br><span>{{ $week_date[4] }}</span>
                                            </th>
                                            <th><span>SAT</span><br><span>{{ $week_date[5] }}</span>
                                            </th>
                                            <th><span>SUN</span><br><span>{{ $week_date[6] }}</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @if (!empty($location_option))
                                            @if (!empty($employees))
                                                @foreach ($employees as $employee)
                                                    {!! $employee->getfourWorkSchedulesolo($employee['id'], $temp_week, $first_location) !!}
                                                @endforeach
                                            @else
                                                <tr>
                                                    <td colspan="8">
                                    ...
                                    @if (Auth::user()->acount_type == 1 || Auth::user()->acount_type == 2 && !empty($location_option) && !empty($employee))
                                        <tfoot class="bt2">
                                            {!! $employee->getCompanyWeeklyUserSalaryfour(0, $created_by, $first_location, 0) !!}
                                        </tfoot>
                                    @endif
                                </table>
                            </div>
                            ...
                            <div class="card-wrapper rotas-timesheet overflow-auto" id="rotas-timesheet">
                                <table class="table work_sheet_table2">
                                    <thead>
                                        <tr class="text-center work_sheet_table">
                                            <th>Week 2</th>
                                            <th><span>MON</span><br><span>{{ $week_date[7] }}</span>
                                            </th>
                                            <th><span>TUE</span><br><span>{{ $week_date[8] }}</span>
                                            </th>
                                            <th><span>WED</span><br><span>{{ $week_date[9] }}</span>
                                            </th>
                                            <th><span>THU</span><br><span>{{ $week_date[10] }}</span>
                                            </th>
                                            <th><span>FRI</span><br><span>{{ $week_date[11] }}</span>
                                            </th>
                                            <th><span>SAT</span><br><span>{{ $week_date[12] }}</span>
                                            </th>
                                            <th><span>SUN</span><br><span>{{ $week_date[13] }}</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @if (!empty($location_option))
                                            @if (!empty($employees))
                                                @foreach ($employees as $employee)
                                                    {!! $employee->getfourWorkScheduleduo($employee['id'], $temp_week, $first_location) !!}
                                                @endforeach
                                            @else
                                                <tr>
                                                    <td colspan="8">
                                    ...
                                    @if (Auth::user()->acount_type == 1 || Auth::user()->acount_type == 2 && !empty($location_option) && !empty($employee))
                                        <tfoot class="bt2">
                                            {!! $employee->getCompanyWeeklyUserSalaryfourduo(0, $created_by, $first_location, 0) !!}
                                        </tfoot>
                                    @endif
                                </table>
                            </div>
                            ...
                            <div class="card-wrapper rotas-timesheet overflow-auto" id="rotas-timesheet">
                                <table class="table work_sheet_table3">
                                    <thead>
                                        <tr class="text-center work_sheet_table">
                                            <th>Week 3</th>
                                            <th><span>MON</span><br><span>{{ $week_date[14] }}</span>
                                            </th>
                                            <th><span>TUE</span><br><span>{{ $week_date[15] }}</span>
                                            </th>
                                            <th><span>WED</span><br><span>{{ $week_date[16] }}</span>
                                            </th>
                                            <th><span>THU</span><br><span>{{ $week_date[17] }}</span>
                                            </th>
                                            <th><span>FRI</span><br><span>{{ $week_date[18] }}</span>
                                            </th>
                                            <th><span>SAT</span><br><span>{{ $week_date[19] }}</span>
                                            </th>
                                            <th><span>SUN</span><br><span>{{ $week_date[20] }}</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @if (!empty($location_option))
                                            @if (!empty($employees))
                                                @foreach ($employees as $employee)
                                                    {!! $employee->getfourWorkScheduletrio($employee['id'], $temp_week, $first_location) !!}
                                                @endforeach
                                            @else
                                                <tr>
                                                    <td colspan="8">
                                    ...
                                    @if (Auth::user()->acount_type == 1 || Auth::user()->acount_type == 2 && !empty($location_option) && !empty($employee))
                                        <tfoot class="bt2">
                                            {!! $employee->getCompanyWeeklyUserSalaryfourtrio(0, $created_by, $first_location, 0) !!}
                                        </tfoot>
                                    @endif
                                </table>
                            </div>
                            ...
                            <div class="card-wrapper rotas-timesheet overflow-auto" id="rotas-timesheet">
                                <table class="table work_sheet_table4">
                                    <thead>
                                        <tr class="text-center work_sheet_table">
                                            <th>Week 4</th>
                                            <th><span>MON</span><br><span>{{ $week_date[21] }}</span>
                                            </th>
                                            <th><span>TUE</span><br><span>{{ $week_date[22] }}</span>
                                            </th>
                                            <th><span>WED</span><br><span>{{ $week_date[23] }}</span>
                                            </th>
                                            <th><span>THU</span><br><span>{{ $week_date[24] }}</span>
                                            </th>
                                            <th><span>FRI</span><br><span>{{ $week_date[25] }}</span>
                                            </th>
                                            <th><span>SAT</span><br><span>{{ $week_date[26] }}</span>
                                            </th>
                                            <th><span>SUN</span><br><span>{{ $week_date[27] }}</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @if (!empty($location_option))
                                            @if (!empty($employees))
                                                @foreach ($employees as $employee)
                                                    {!! $employee->getfourWorkSchedulequadra($employee['id'], $temp_week, $first_location) !!}
                                                @endforeach
                                            @else
                                                <tr>
                                                    <td colspan="8">
                                    ...
                                    @if (Auth::user()->acount_type == 1 || Auth::user()->acount_type == 2 && !empty($location_option) && !empty($employee))
                                        <tfoot class="bt2">
                                            {!! $employee->getCompanyWeeklyUserSalaryfourquad(0, $created_by, $first_location, 0) !!}
                                        </tfoot>
                                    @endif
                                </table>
                            </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.weak_go', function() {
                    ...
                    $.ajax({
                        url: '{{ route('rotas.week_sheet_four') }}',
                        method: 'post',
                        data: data,
                        success: function(data) {
                            console.log(data);
                ...
                $(document).on('click', '.weak_go', function() {
                    ...
                    $.ajax({
                        url: '{{ route('rotas.week_sheet_four_two') }}',
                        method: 'post',
                        data: data,
                        success: function(data) {
                            // console.log(data);
                ...
                $(document).on('click', '.weak_go', function() {
                    ...
                    $.ajax({
                        url: '{{ route('rotas.week_sheet_four_three') }}',
                        method: 'post',
                        data: data,
                        success: function(data) {
                            // console.log(data);
                ...
                $(document).on('click', '.weak_go', function() {
                    ...
                    $.ajax({
                        url: '{{ route('rotas.week_sheet_four_quad') }}',
                        method: 'post',
                        data: data,
                        success: function(data) {
                            // console.log(data);
                ...
                $('.rotas_filter').on('click', '.dropdown-item', function(e) {
                    ...
                    if (val == 'clear_week') {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.clear_weekfoursolo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.clear_weekfourduo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.clear_weekfourtrio') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.clear_weekfourquad') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                ...
                $(document).on('click', '.work_sheet_table2>tbody>tr>td.droppable-class', function() {
                    ...
                    if ($('.add_remove_amoff').css('display') != 'none' && $('.add_remove_amoff').length >
                        ...
                        if (has_dayoff != true) {
                            ...
                            show_toastr('{{ __('This day already AM off') }}', '{!! session('error') !!}',
                                'error');
                        }
                    }
            ...
            $(document).on('click', '.Copy_Week_Shift', function() {
                ...
                $.ajax({
                    url: '{{ route('copy_week_sheet4solo') }}',
                    method: 'POST',
                    data: data,
                    context: this,
                    success: function(data) {
            ...
            function publish_week() {
                ...
                $.ajax({
                    url: '{{ route('rotas.publish_weekfoursolo') }}',
                    method: 'POST',
                    data: data,
                    success: function(data) {
                        if (data["status"] == 'success') {
                ...
                $.ajax({
                    url: '{{ route('rotas.publish_weekfourduo') }}',
                    method: 'POST',
                    data: data,
                    success: function(data) {
                        // if (data["status"] == 'success') {
                ...
                $.ajax({
                    url: '{{ route('rotas.publish_weekfourtrio') }}',
                    method: 'POST',
                    data: data,
                    success: function(data) {
                        // if (data["status"] == 'success') {
                ...
                $.ajax({
                    url: '{{ route('rotas.publish_weekfourquad') }}',
                    method: 'POST',
                    data: data,
                    success: function(data) {
                        // if (data["status"] == 'success') {
            ...
            function un_publish_week() {                
                    // $('.publish_shifs').on('click', '#un_publish_week', function() {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.un_publish_weekfoursolo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                                if (data["status"] == 'success') {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.un_publish_weekfourduo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                                // if (data["status"] == 'success') {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.un_publish_weekfourtrio') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                                // if (data["status"] == 'success') {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.un_publish_weekfourquad') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                                // if (data["status"] == 'success') {
