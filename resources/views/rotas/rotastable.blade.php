            ...
            <div style="width:1000px;margin-left: auto;margin-right: auto; background-color: #dddddd26; height: 98vh;">
                <div class="bg-primary" style="padding: 20px 25px;">
                    <div class="bg-primary" style="padding: 20px 25px;display: inline-block;">
                        <img src="{{ asset('storage/uploads/logo/logo-light.png') }}" style="width: 100%; display: inline-block; float: left; max-width: 150px;">
                    </div>
                    <div style="display: inline-block; float: right; color: white; width: 250px; text-align: left;">
                        <div class="mb10">{{ (!empty($location_data)) ? $location_data->name : '' }}</div>
                ...
                <table id="t01" style="margin: 20px 15px;">
                    <thead>
                        <tr>
                            ...
                            <th class="bg-primar">{{ __('Notes') }}</th>
