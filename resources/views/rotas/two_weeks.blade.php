                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-auto my-auto">
                                            <div class="d-inline-block text-white">
                                                ...
                                                &nbsp;<span class="weak_go_html weak_go_html text-primary"><b>{{ $week_date[0] . ' - ' . $week_date[13] }}</b></span>&nbsp;
                                            ...
                                            <div class="btn-group card-option">
                                                <button type="button" class="btn btn-sm btn-primary btn-icon m-1 Copy_Week_Shift">
                                                    <i class="feather icon-move" 
                                                        data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __(' Copy rotas to next period ') }}"></i>
                                                </button>
                                            </div>
                            ...
                            <div class="card-wrapper rotas-timesheet overflow-auto" id="rotas-timesheet">
                                <table class="table work_sheet_table1">
                                    ...
                                    @if (Auth::user()->acount_type == 1 || Auth::user()->acount_type == 2 && !empty($location_option) && !empty($employee))
                                        <tfoot class="bt2">
                                            {!! $employee->getCompanyWeeklyUserSalaryone(0, $created_by, $first_location, 0) !!}
                                        </tfoot>
                                    @endif
                                </table>
                            </div>
                                ...
                                <table class="table work_sheet_table2">
                                    ...
                                    <tbody>
                                        @if (!empty($location_option))
                                            @if (!empty($employees))
                                                @foreach ($employees as $employee)
                                                    {!! $employee->getsecondWorkScheduletwo($employee['id'], $temp_week, $first_location) !!}
                                                @endforeach
                                            @else
                                                <tr>
                                                    <td colspan="8">
                                    ...
                                    @if (Auth::user()->acount_type == 1 || Auth::user()->acount_type == 2 && !empty($location_option) && !empty($employee))
                                        <tfoot class="bt2">
                                            {!! $employee->getCompanyWeeklyUserSalarytwo(0, $created_by, $first_location, 0) !!}
                                        </tfoot>
                                    @endif
                                </table>
                            </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.weak_go', function() {
                    ...
                    $.ajax({
                        url: '{{ route('rotas.week_sheet_second') }}',
                        method: 'post',
                        data: data,
                        success: function(data) {
                            // console.log(data);
                ...
                $(document).on('click', '.weak_go', function() {
                    ...
                    $.ajax({
                        url: '{{ route('rotas.week_sheet_second_two') }}',
                        method: 'post',
                        data: data,
                        success: function(data) {
                            // console.log(data);
                ...
                $('.rotas_filter').on('click', '.dropdown-item', function(e) {
                    ...
                    if (val == 'clear_week') {
                        $.ajax({
                            url: '{{ route('rotas.clear_weektwosolo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.clear_weektwoduo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
            ...
            $(document).on('click', '.Copy_Week_Shift', function() {
                ...
                $.ajax({
                    url: '{{ route('copy_week_sheet2solo') }}',
                    method: 'POST',
                    data: data,
                    context: this,
                    success: function(data) {
            ...
            function publish_week() {
                ...
                $.ajax({
                    url: '{{ route('rotas.publish_weektwosolo') }}',
                    method: 'POST',
                    data: data,
                    success: function(data) {
                        if (data["status"] == 'success') {
                ...
                $.ajax({
                    url: '{{ route('rotas.publish_weektwoduo') }}',
                    method: 'POST',
                    data: data,
                    success: function(data) {
                        // if (data["status"] == 'success') {
            ...
            function un_publish_week() {                
                    // $('.publish_shifs').on('click', '#un_publish_week', function() {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.un_publish_weektwosolo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                                if (data["status"] == 'success') {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.un_publish_weektwoduo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                                // if (data["status"] == 'success') {
