                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-auto my-auto">
                                            <div class="d-inline-block text-white">
                                                ...
                                                &nbsp;<span class="weak_go_html weak_go_html text-primary"><b>{{ $week_date[0] . ' - ' . $week_date[20] }}</b></span>&nbsp;
                            ...
                            <div class="card-wrapper rotas-timesheet overflow-auto" id="rotas-timesheet">
                                <table class="table work_sheet_table1">
                                        ...
                                        @if (!empty($location_option))
                                            @if (!empty($employees))
                                                @foreach ($employees as $employee)
                                                    {!! $employee->getthirdWorkSchedulethird($employee['id'], $temp_week, $first_location) !!}
                                                @endforeach
                                            @else
                                                <tr>
                                                    <td colspan="8">
                                    ...
                                    @if (Auth::user()->acount_type == 1 || Auth::user()->acount_type == 2 && !empty($location_option) && !empty($employee))
                                        <tfoot class="bt2">
                                            {!! $employee->getCompanyWeeklyUserSalarythree(0, $created_by, $first_location, 0) !!}
                                        </tfoot>
                                    @endif
                                </table>
                            </div>
                                ...
                                <table class="table work_sheet_table2">
                                    ...
                                    <tbody>
                                        @if (!empty($location_option))
                                            @if (!empty($employees))
                                                @foreach ($employees as $employee)
                                                    {!! $employee->getthirdWorkScheduleduo($employee['id'], $temp_week, $first_location) !!}
                                                @endforeach
                                            @else
                                                <tr>
                                                    <td colspan="8">
                                    ...
                                    @if (Auth::user()->acount_type == 1 || Auth::user()->acount_type == 2 && !empty($location_option) && !empty($employee))
                                        <tfoot class="bt2">
                                            {!! $employee->getCompanyWeeklyUserSalarythreeduo(0, $created_by, $first_location, 0) !!}
                                        </tfoot>
                                    @endif
                                </table>
                            </div>
                                ...
                                <table class="table work_sheet_table3">
                                    ...
                                    <tbody>
                                        @if (!empty($location_option))
                                            @if (!empty($employees))
                                                @foreach ($employees as $employee)
                                                    {!! $employee->getthirdWorkScheduletrio($employee['id'], $temp_week, $first_location) !!}
                                                @endforeach
                                            @else
                                                <tr>
                                                    <td colspan="8">
                                    ...
                                    @if (Auth::user()->acount_type == 1 || Auth::user()->acount_type == 2 && !empty($location_option) && !empty($employee))
                                        <tfoot class="bt2">
                                            {!! $employee->getCompanyWeeklyUserSalarythreetrio(0, $created_by, $first_location, 0) !!}
                                        </tfoot>
                                    @endif
                                </table>
                            </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.weak_go', function() {
                    ...
                    $.ajax({
                        url: '{{ route('rotas.week_sheet_third') }}',
                        method: 'post',
                        data: data,
                        success: function(data) {
                            // console.log(data);
                ...
                $(document).on('click', '.weak_go', function() {
                    ...
                    $.ajax({
                        url: '{{ route('rotas.week_sheet_third_two') }}',
                        method: 'post',
                        data: data,
                        success: function(data) {
                            // console.log(data);
                ...
                $(document).on('click', '.weak_go', function() {
                    ...
                    $.ajax({
                        url: '{{ route('rotas.week_sheet_third_three') }}',
                        method: 'post',
                        data: data,
                        success: function(data) {
                            // console.log(data);
                ...
                $('.rotas_filter').on('click', '.dropdown-item', function(e) {
                    ...
                    if (val == 'clear_week') {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.clear_weekthirdsolo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.clear_weekthirdduo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.clear_weekthirdtrio') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
            ...
            $(document).on('click', '.Copy_Week_Shift', function() {
                ...
                $.ajax({
                    url: '{{ route('copy_week_sheet3solo') }}',
                    method: 'POST',
                    data: data,
                    context: this,
                    success: function(data) {
            ...
            function publish_week() {
                ...
                $.ajax({
                    url: '{{ route('rotas.publish_weekthreesolo') }}',
                    method: 'POST',
                    data: data,
                    success: function(data) {
                        if (data["status"] == 'success') {
                ...
                $.ajax({
                    url: '{{ route('rotas.publish_weekthreeduo') }}',
                    method: 'POST',
                    data: data,
                    success: function(data) {
                        // if (data["status"] == 'success') {
                ...
                $.ajax({
                    url: '{{ route('rotas.publish_weekthreetrio') }}',
                    method: 'POST',
                    data: data,
                    success: function(data) {
                        // if (data["status"] == 'success') {
            ...
            function un_publish_week() {                
                    // $('.publish_shifs').on('click', '#un_publish_week', function() {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.un_publish_weekthreesolo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                                if (data["status"] == 'success') {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.un_publish_weekthreeduo') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                                if (data["status"] == 'success') {
                        ...
                        $.ajax({
                            url: '{{ route('rotas.un_publish_weekthreetrio') }}',
                            method: 'POST',
                            data: data,
                            success: function(data) {
                                if (data["status"] == 'success') {
