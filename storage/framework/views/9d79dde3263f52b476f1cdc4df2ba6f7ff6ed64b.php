                    ...
                    <div class="card">
                        <div class="card-header card-body">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-md-8">
                                    <div class="row">
                                        <input type="hidden" name="custom_dayoff" id="custom_dayoff" value="dayoff">
                                    ...
                                    <div
                                        ...
                                        <div class="rotas_filter_main_div_responce">
                                            <div class="add_remove_amoff" style="display: none;">
                                                ...
                                                <button type="button"
                                                    class="dropdown-toggle btn btn-sm btn-primary btn-icon m-1 dayoff_closeam"
                                                    data-toggel="tooltip"
                                                    title="<?php echo e(__('Back to Rota Builder')); ?>"><span
                                                        class="btn-inner--icon"><i
                                                            class="fas fa-times"></i></span></button>
                                        ...
                                        <div class="rotas_filter_main_div_responce">
                                            <div class="add_remove_pmoff" style="display: none;">
                                                ...
                                                <button type="button"
                                                    class="dropdown-toggle btn btn-sm btn-primary btn-icon m-1 dayoff_closepm"
                                                    data-toggel="tooltip"
                                                    title="<?php echo e(__('Back to Rota Builder')); ?>"><span
                                                        class="btn-inner--icon"><i
                                                            class="fas fa-times"></i></span></button>
                                    ...
                                    <div
                                        ...
                                        <div class="rotas_filter_main_div">
                                            ...
                                            <div class="btn-group card-option">
                                                <button type="button" class="btn btn-sm btn-primary btn-icon m-1 Copy_Week_Shift">
                                                    <i class="feather icon-move"
                                                        data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__(' Copy rotas nexy week ')); ?>"></i>
                                                </button>
                                            </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('change', '.rotas_location_change', function() {
                    ...
                    // var custom = $("#custom_dayoff").val();
                    // if(custom == "am"){

                        // $.ajax({
                        //     url: '<?php echo e(route('rotas.week_sheetam')); ?>',
                        //     method: 'post',
                        //     data: data,
                        //     success: function(data) {
                        //         console.log(data);
                    ...
                    //     $.ajax({
                    //         url: '<?php echo e(route('rotas.week_sheetpm')); ?>',
                    //         method: 'post',
                    //         data: data,
                    //         success: function(data) {
                    //             console.log(data);
                ...
                $(document).on('change', '.rotas_location_changeam', function() {
                    alert("ok");
                    var start_date = $('.week_last_daye').attr('data-start');
                    var end_date = $('.week_last_daye').attr('data-end');
                    var week = $('.week_add_sub').val();
                ...
                // $(".add_remove_dayeoff").click(function(){
                    // $(this).parent().hide();
                    // $(this).parent().hide();
                    // $('.rotas_filter_main_div').show();
                    // location.reload();
                ...
                // $('.rotas_filter_main_div_responce').on('click', '.add_remove_dayeoff .dayoff_closeam' , function() {
                //     $(this).parent().hide();
                //     // $(this).parent().hide();
                //     $('.rotas_filter_main_div').show();
                //     location.reload();
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sandbox\resources\views/rotas/index.blade.php ENDPATH**/ ?>