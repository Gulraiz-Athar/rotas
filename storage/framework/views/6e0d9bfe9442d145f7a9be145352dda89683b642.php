                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="page-header-title">
                            <h4 class="m-b-10"><?php echo e(__('Yearly View')); ?></h4>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo e(url('dashboard')); ?>"><?php echo e(__('Home')); ?></a></li>
                            <li class="breadcrumb-item"><?php echo e(__('Yearly View')); ?></li>
                        </ul>
                    </div>
                    ...
                    <div class="card-header card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-md-8">
                                ...
                                <h5 class="fullcalendar-title h4 d-inline-block font-weight-400 mb-0 text-black"><?php echo e(_('Calendar')); ?>
                    ...
                    <div class="btn-group card-option">
                        ...
                        <i class="ti ti-dots-vertical" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Menu" aria-label="Menu"></i>
                            ...
                            <div class="dropdown-menu dropdown-menu-end" style="">
                                ...
                                <a href="<?php echo e(url('holidays')); ?>" onclick="window.location.href=this;"
                                    class="dropdown-item" id="view_employee"><?php echo e(__('View All Leave')); ?></a>
                                <?php if(Auth::user()->acount_type == 2 || Auth::user()->acount_type == 1): ?>
                                    <a href="<?php echo e(url('embargoes')); ?>" onclick="window.location.href=this;"
                                        class="dropdown-item" id="removed_employee"><?php echo e(__('Embargoes')); ?></a>
                                <?php endif; ?>

                                <?php if(Auth::user()->acount_type == 1): ?>
                                    <a href="<?php echo e(url('rules')); ?>" onclick="window.location.href=this;"
                                        class="dropdown-item d-none" id="edit_group"><?php echo e(__('Request Rules')); ?></a>
                                <?php endif; ?>

                                <?php if(Auth::user()->acount_type == 2 ||Auth::user()->acount_type == 1 ): ?>
                                    <a href="<?php echo e(url('leave-request')); ?>" onclick="window.location.href=this;"
                                        class="dropdown-item" id="edit_group"><?php echo e(__('Leave Request')); ?></a>
                                <?php endif; ?>

                                    <a href="<?php echo e(url('holidays/monthly')); ?>" onclick="window.location.href=this;"
                                        class="dropdown-item " id="edit_group"><?php echo e(__('Monthly Leaves View')); ?></a>
                                    <a href="<?php echo e(url('holidays/yearly')); ?>" onclick="window.location.href=this;"
                                        class="dropdown-item " id="edit_group"><?php echo e(__('Yearly Leaves View')); ?></a>
                            ...
                            <div class="btn btn-sm btn-primary btn-icon m-1">
                                <a href="#" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Add Employee Leave')); ?>" data-url="<?php echo e(route('holidays.create')); ?>">
                                    <i class="ti ti-plus text-white" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Add New Leave')); ?>" data-bs-original-title="<?php echo e(__('Add New Leave')); ?>" aria-label="<?php echo e(__('Add New Leave')); ?>"></i>
                                </a>
                            </div>       
                                </div>
                            </div>
                ...
                <div class="card overflow-hidden">
                    <?php if(!empty($employees) && count($employees) > 0): ?>
                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="text-center" data-id="<?php echo e($employee->id); ?>">
...
<?php $__env->startPush('pagescript'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/libs/fullcalendar/dist/fullcalendar.css')); ?>">
    <script src="<?php echo e(asset('assets/libs/fullcalendar/dist/fullcalendar.js')); ?>"></script>
    
    <script>
        var feed_calender = <?php echo $feed_calendar; ?>;
        // console.log(feed_calender);
            ...
            a.length && (t = {
                ...
                $("body").on("click", "[data-calendar]", function() {
                    ...
                    "update" === t && ("" != n ? (s[0].title = n, s[0].description = o, s[0].className = [
                        ...
                        // console.log(i),
                         e.fullCalendar("updateEvent", s[0]), $("#edit-event").modal(
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sandbox\resources\views/leave/yearview.blade.php ENDPATH**/ ?>